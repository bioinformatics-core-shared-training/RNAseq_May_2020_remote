...
for differential analysis. Before we do that we need to:
...
```{r proProcObjChal2, echo=FALSE, eval=FALSE}
# have object ready for challenge
# need logcounts and logNormalizedCounts
save(countdata, sampleinfo, file="Robjects/preprocessingChal2.RData")
```

```{r solutionChallenge2, echo=FALSE, fig.height=10, fig.width=10}
